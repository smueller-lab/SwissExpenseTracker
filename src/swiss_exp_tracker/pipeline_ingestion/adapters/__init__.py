...
from swiss_exp_tracker.pipeline_ingestion.adapters.adapters import SwissquoteAdapter
...
__all__ = ["RevolutAdapter", "SwissquoteAdapter", "VisecaAdapter", "ZKBDebitAdapter"]
