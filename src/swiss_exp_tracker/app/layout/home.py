...
def layout(data: Any, pos: Any) -> Any:
    ...
    return html.Div(
        [
            make_page_title("📊 Financial Overview"),
            html.Div(
                [
                    make_number_card(
                        "Current Balance", data.z_StatsTable["Balance_current"]
                    ),
                    ...
                    ##
                    make_CategoryDonut_card(
                        "Expense distribution", data.pdf_CatMain, width=5
                    ),
                    make_table_card(
