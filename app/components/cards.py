...
from app.dash_components import format_diff
from app.dash_components import get_balance_class
from app.dash_components import make_card_title


vis = VIS()


def make_number_card(title: str, Number: float, width: int = 3) -> Any:
    return html.Div(
        [
